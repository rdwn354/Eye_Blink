        ...
        try:
            while cap.isOpened():
                ...
                if class_label == "close":
                    ...
                    screenshot_name = f"{self.output_folder}/screenshot_{self.close_folder_count}.png"
                ...
                cv2.putText(frame, f"status CVS : {'csv' if self.status else 'normal'}", (234, 73), self.font, self.size_font, (255,255,255), 1)
                ...
                cv2.putText(frame, f"fps : {fps}", (234, 118), self.font, self.size_font, (255,255,255), 1)
